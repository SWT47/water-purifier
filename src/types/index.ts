...
export const CATEGORY_EXCEL_COLUMN_MAP: Record<ProductCategory, Record<string, string>> = {
  water_purifier: {
    '品牌': 'brand', '名称': 'name', '型号': 'model', '商品白底图': 'whiteBgImage',
    '上架年份': 'launchYear', '是否在售': 'isOnSale', '日常价格': 'dailyPrice',
    '参考价格': 'referencePrice', '通量': 'flux', '出水速度': 'waterFlowRate',
    '水龙头': 'faucet', '尺寸': 'dimensions', '出水模式': 'waterMode',
    'RO膜品牌': 'roMembraneBrand', '滤芯总和成本': 'filterTotalCost',
    '活性炭用料': 'activatedCarbon', '是否有母婴认证': 'hasMaternityCert',
    '是否有0陈水': 'hasZeroStagnantWater', '产品实拍图': 'realImages',
    '产品实拍视频': 'realVideos',
  },
  pipeline_machine: {
    '品牌': 'brand', '型号': 'model', '白底图': 'whiteBgImage', '尺寸': 'dimensions',
    '加热体': 'heatingElement', '制热能力': 'heatingCapacity', '参考价格': 'referencePrice',
    '控温控量': 'tempControl', '有无水箱': 'hasWaterTank', '实拍图': 'realImages',
    '实拍视频': 'realVideos',
  },
  pre_filter: {
    '品牌': 'brand', '型号': 'model', '白底图': 'whiteBgImage', '参考价格': 'referencePrice',
    '尺寸': 'dimensions', '通量': 'flux', '是否全自动': 'isAutomatic',
    '实拍图': 'realImages', '实拍视频': 'realVideos',
  },
  big_white_bottle: {
    '品牌': 'brand', '名称': 'name', '型号': 'model', '白底图': 'whiteBgImage',
    '参考价格': 'referencePrice',
  },
  central_purifier: {
    '品牌': 'brand', '名称': 'name', '型号': 'model', '白底图': 'whiteBgImage',
