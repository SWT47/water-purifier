...
const MOCK_PRODUCTS: Product[] = [
  {
    ...
    model: 'MR842-C',
    imageUrl: 'https://picsum.photos/seed/water1/600/600',
    referencePrice: 2499,
    params: {
      通量: '800G',
      出水速度: '2.15L/min',
    ...
    realVideoUrl: '',
    description:
      '小米净水器H800G Pro，采用陶氏RO反渗透膜，800G大通量，2.15L/min出水速度，支持0陈水技术，首杯即可直饮。',
  ...
  },
  {
    ...
    imageUrl: 'https://picsum.photos/seed/water2/600/600',
    referencePrice: 3299,
    params: {
      通量: '1000G',
      出水速度: '2.72L/min',
    ...
    description: '美的白泽1000G Pro，1000G超大通量，RO膜6年免换，滤芯成本低。',
  ...
  },
  {
    ...
    model: 'CWG-RA08',
    imageUrl: 'https://picsum.photos/seed/water3/600/600',
    referencePrice: 2999,
    params: {
      制热能力: '即开即热',
      控温方式: '6档控温',
    ...
    description: 'COLMO高端管线机，6档控温，即开即热，无内胆设计。',
  ...
  },
  {
    ...
    model: 'BFS3-40BK',
    imageUrl: 'https://picsum.photos/seed/water4/600/600',
    referencePrice: 899,
    params: {
      通量: '4T/h',
      全自动冲洗: true,
    ...
    realImages: [],
    description: '3M前置过滤器，4T大流量，全自动反冲洗，终身免换滤芯。',
  ...
  },
  {
    ...
    model: 'BF-10-B',
    imageUrl: 'https://picsum.photos/seed/water5/600/600',
    referencePrice: 1299,
    params: {
      通量: '2T/h',
    },
    realImages: [],
    description: '滨特尔10寸大白瓶，大流量全屋过滤，可搭配PP棉/活性炭滤芯。',
  ...
  },
  {
    ...
    name: '怡口中央净水机 全屋净化系统',
    model: 'ETF2100PF10',
    imageUrl: 'https://picsum.photos/seed/water6/600/600',
    referencePrice: 8800,
    params: {
      通量: '2.5T/h',
    },
    realImages: [],
    description: '怡口全屋中央净水机，活性炭+KDF，去除余氯重金属。',
  ...
  },
  {
    ...
    name: '中央软水机 家用全屋软水系统',
    model: 'RS-1T',
    imageUrl: 'https://picsum.photos/seed/water7/600/600',
    referencePrice: 4599,
    params: {
      通量: '1T/h',
    },
    realImages: [],
    description: '全屋软水机，去除水垢，保护涉水家电，美容护肤。',
  ...
  },
  {
    ...
    model: 'HRO600-4A',
    imageUrl: 'https://picsum.photos/seed/water8/600/600',
    referencePrice: 1899,
    params: {
      通量: '600G',
      出水速度: '1.5L/min',
    ...
    realImages: [],
    description: '海尔高性价比净水器，600G通量，双出水设计。',
